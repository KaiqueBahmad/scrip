...
const MODELS = {
  charge: [
    ...
    { name: 'fee_amount', type: 'integer', descriptionKey: 'documentation.models.charge.fee_amount' },
  ...
  merchant: [
    ...
    { name: 'pix_fee_in_bps', type: 'integer', descriptionKey: 'documentation.models.merchant.pix_fee_in_bps' },
    { name: 'pix_fee_out_bps', type: 'integer', descriptionKey: 'documentation.models.merchant.pix_fee_out_bps' },
    { name: 'pix_fee_in_fixed', type: 'integer', descriptionKey: 'documentation.models.merchant.pix_fee_in_fixed' },
    { name: 'pix_fee_out_fixed', type: 'integer', descriptionKey: 'documentation.models.merchant.pix_fee_out_fixed' },
  ...
  withdrawal: [
    ...
    { name: 'fee_amount', type: 'integer', descriptionKey: 'documentation.models.withdrawal.fee_amount' },
...
const INTEGRATION_ROUTES: RouteDoc[] = [
  ...
  },
  {
    ...
    body: [
      ...
      { name: 'pix_fee_in_bps', type: 'integer', descriptionKey: 'documentation.routes.updateMerchant.pix_fee_in_bps' },
      { name: 'pix_fee_out_bps', type: 'integer', descriptionKey: 'documentation.routes.updateMerchant.pix_fee_out_bps' },
      { name: 'pix_fee_in_fixed', type: 'integer', descriptionKey: 'documentation.routes.updateMerchant.pix_fee_in_fixed' },
      { name: 'pix_fee_out_fixed', type: 'integer', descriptionKey: 'documentation.routes.updateMerchant.pix_fee_out_fixed' },
    ],
    response: { kind: 'object', model: 'merchant' },
    exampleBody: '{\n  "name": "Minha loja",\n  "webhook_url": "https://example.test/webhook",\n  "pix_fee_in_bps": 250,\n  "pix_fee_in_fixed": 100\n}',
  },
  {
